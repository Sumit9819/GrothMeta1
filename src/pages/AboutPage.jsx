            ...
            <section className="section">
                <div className="container">
                    <div style={{ marginBottom: '6rem' }}>
                        ...
                        <p style={{ color: 'var(--text-secondary)', marginBottom: '1.5rem', lineHeight: '1.7' }}>
                            We believe in transparency, data, and results. Our mission is to demystify digital growth and provide businesses with the clear, actionable strategies they need to thrive in a competitive landscape.
                        </p>
                    </div>

                    <div style={{ marginBottom: '4rem' }}>
                        <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem', textAlign: 'center' }}>Meet the Team</h2>
                        <div style={{
                            display: 'grid',
                            ...
                            {displayTeam.map((member, index) => (
                                <div key={index} style={{ background: 'var(--bg-secondary)', border: '1px solid var(--border-subtle)', borderRadius: '12px', overflow: 'hidden' }}>
